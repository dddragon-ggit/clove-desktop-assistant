Create a single horizontal sprite strip for the Codex app digital pet `mudie` in the state `running-right`.
...
Repair attempt 1:
- The previous `running-right` strip failed QA: running-right frame 00 has 932 non-transparent pixels close to the chroma key; running-right frame 01 has 976 non-transparent pixels close to the chroma key; running-right frame 02 has 934 non-transparent pixels close to the chroma key; running-right frame 03 has 871 non-transparent pixels close to the chroma key; running-right frame 04 has 1063 non-transparent pixels close to the chroma key; running-right frame 05 has 958 non-transparent pixels close to the chroma key; running-right frame 06 has 953 non-transparent pixels close to the chroma key; running-right frame 07 has 911 non-transparent pixels close to the chroma key
